...
function BookingInFor(props) {
  ...
  return (
    <div className="ui card customCard">
      <div className="content">
        <div className="header">Thông tin đặt chỗ</div>
      </div>
      <div className="content">
        <h4 className="ui sub header">Thông tin hành khách</h4>
      ...
      <div className="content">
        <h4 className="ui header">Chuyến đi</h4>
        <div className="ui small feed">
          <div className="event">
            <div className="content">
              <div className="summary">
      ...
      {props.type === 'roundtrip' &&
        <div className="content">
          <h4 className="ui header">Chuyến về</h4>
          <div className="ui small feed">
            <div className="event">
              <div className="content">
                <div className="summary">
